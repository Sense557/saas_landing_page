                ...
                <div className="container">
                    <div className="flex items-center">
                        <div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100">
                            <div className="mb-10">
                                <img src="images/xora.svg" height={55} width={160} alt="xora"/>
                            </div>
                            <p className="body-1 max-w-md mb-10">Try it for free on iOS, Android, PC, Web - whatever your flavour, we've got you covered
                            </p>
                            <ul className="flex flex-wrap items-center gap-6">
                                {links.map(({id, url, icon}) => (
                                    <li key={id} className="download_tech-link download_tech-link_last-before download_tech-link_last-after ">
                                        <a href={url} className="size-22 download_tech-icon_before relative flex items-center justify-center border-2 rounded-half border-s3 bg-s1 transition-borderColor duration-500">
                        ...
                        <div className="mb-10 max-md:hidden">
                            <div className="download_preview-before download_preview-after rounded-40 relative w-[955px] border-2 border-s5 p-6">
                                <div className="relative rounded-3xl bg-s1 px-6 pb-6 pt-14">
                                    ...
                                    <sp className="download_preview-dot left-11 bg-s3" />
